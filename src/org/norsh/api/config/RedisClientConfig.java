...
/**
 * Redis configuration for the API layer.
 * <p>
 * This configuration extends {@link RedisClient} to initialize Redis connection settings dynamically
 * from {@link ApiConfig}, ensuring proper integration with the API environment.
 * </p>
 *
 * <h2>Key Features:</h2>
 * <ul>
 *   <li>Retrieves Redis connection properties from {@link ApiConfig}.</li>
...
public class RedisClientConfig extends RedisClient {
    ...
    /**
     * Initializes the Redis connection factory using the configuration from {@link ApiConfig}.
     * <p>
